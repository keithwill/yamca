...
/// <summary>
/// Controls whether a tool's schema is sent to the LLM, hidden behind <c>load_tool</c>,
/// or suppressed entirely. The effective value is resolved per call by
...
public enum Availability
{
    ...
    /// <summary>Not in the initial schema. Discoverable via <c>load_tool</c>; loaded on demand.</summary>
    Deferred,

    /// <summary>Completely invisible to the LLM. Not listed by <c>load_tool</c>, not callable
